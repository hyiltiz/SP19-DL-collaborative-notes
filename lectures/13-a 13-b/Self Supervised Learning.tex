...
\begin{figure}[h!]
\begin{center}
  \includegraphics[width=.6\linewidth]{shuffle-learn.png}
...
\begin{figure}[h!]
\begin{center}
  \includegraphics[width=.6\linewidth]{odd-one-out-network.png}
...
\begin{figure}[h!]
\begin{center}
  \includegraphics[width=.6\linewidth]{audio-video.png}
